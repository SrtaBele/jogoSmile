    ...
    let acertos = 0;
    let jogar = true;
    let corOriginal = ""; // nova variável para armazenar a cor original
    ...
    function jogarNovamente() {
      ...
      corOriginal = document.body.style.backgroundColor; // armazena a cor original
      ...
      //armazenamos a imagem do meme na variável imagem2 (getElementById)
      let imagem2 = document.getElementById("imagem2");
      //se a imagem2 nao for vazia (se ela existir)
      if (imagem2 != "") {
        //removemos a imagem do meme
        imagem2.remove();
      }
      // retorna a cor de fundo original
    ...
    function acertou(obj) {
      ...
      img.src = "https://blog.elcabriton.com/wp-content/uploads/2022/08/cca27-meme-e-mene-1.jpg?w=625";
    ...
    function verifica(obj) {
      ...
      if (jogar) {
        ...
        if (obj.id == sorteado) {
          ...
          img.id = "imagem2";
          //altera o atributo src (source) da imagem criada
          img.src = "https://www.patasdacasa.com.br/sites/default/files/inline-images/cachorro%20com%20fone%20de%20ouvido.jpg";
          //adiciona a imagem criada na div (obj) escolhida pelo jogador (appendChild)
         obj.appendChild(img);
